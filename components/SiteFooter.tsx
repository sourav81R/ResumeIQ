      ...
      <div className="container mx-auto max-w-6xl py-8">
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-5">
          <div className="space-y-3 xl:col-span-1">
            <h3 className="font-display text-2xl font-bold italic tracking-tight text-white">ResumeIQ</h3>
            ...
            <div className="flex items-center gap-2.5">
              <a
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-600 bg-[#0b2242]/80 text-slate-200 transition hover:border-cyan-400 hover:text-cyan-300"
              >
          ...
          <div className="space-y-2.5">
            ...
            <div className="space-y-2.5">
              <Link
                href="/upload"
                className="flex items-center justify-between rounded-xl border border-slate-600 bg-[#0b2242]/75 px-3 py-1.5 transition hover:border-cyan-400 hover:bg-[#102f56]"
              >
                <div>
        ...
        <div className="mt-7 border-t border-slate-700/80 pt-5 text-center text-sm text-slate-400">
